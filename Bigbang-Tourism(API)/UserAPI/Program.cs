...
using UserAPI.Repository.Service;
...
builder.Services.AddDbContext<UserContext>(optionsAction: options => options.UseSqlServer(builder.Configuration.GetConnectionString(name: "Tourism")));
